...
export const meta: MetaFunction = () => [
  {title: 'Age Verification Failed | Vapourism'},
  {
    name: 'description',
    content: 'Age verification unsuccessful. You can retry verification or contact customer support for assistance with your order.',
  },
];
