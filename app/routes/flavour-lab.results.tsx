...
export const meta: MetaFunction<typeof loader> = ({data}) => {
  ...
  return [
    {title: `Your Flavour Matches (${count} products) | Vapourism`},
    {
      name: 'description',
      content: `Found ${count} e-liquids and flavours matching your taste preferences. Shop your personalised recommendations with fast UK delivery.`,
    },
...
export async function loader({request, context}: LoaderFunctionArgs) {
  ...
  try {
    ...
    console.error('Flavour lab results error:', error);
    return json<LoaderData>({
      products: [],
      totalCount: 0,
...
export default function FlavourLabResultsRoute() {
  ...
  const handleClearFilters = () => {
    ...
    newParams.set('source', 'flavour-lab');
    setSearchParams(newParams);
  ...
  return (
    <div className="bg-gradient-to-b from-white via-slate-50 to-slate-100">
      ...
      <div
        ...
        style={{
          background: `linear-gradient(135deg, #5b2be0 0%, #1fb2ff 100%)`,
        }}
      >
        <div className="container-custom">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold md:text-4xl">Your Flavour Matches</h1>
              <p className="mt-2 text-white/80">
                {data.totalCount} products matched your taste preferences
              </p>
            </div>
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          >
            ...
            {activeFilterChips.length > 0 && (
              <span className="rounded-full bg-[#5b2be0] px-2 py-0.5 text-xs font-bold text-white">
        ...
        {activeFilterChips.length > 0 && (
          <div className="mb-6 flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="text-sm font-medium text-[#5b2be0] hover:underline"
            >
              Clear all
            </button>
          </div>
