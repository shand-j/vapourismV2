        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/search?type=Disposable" className="text-gray-300 hover:text-white transition-colors">
                  Disposable Vapes
                </Link>
              </li>
              <li>
                <Link to="/search?type=E-Liquid" className="text-gray-300 hover:text-white transition-colors">
                  E-Liquids
                </Link>
              </li>
              <li>
                <Link to="/search?type=Pod+System" className="text-gray-300 hover:text-white transition-colors">
                  Pod Systems
                </Link>
              </li>
              <li>
                <Link to="/search?type=Coil" className="text-gray-300 hover:text-white transition-colors">
                  Coils & Pods
                </Link>
              </li>
              <li>
                <Link to="/search?type=CBD" className="text-gray-300 hover:text-white transition-colors">
                  CBD Products
                </Link>
              </li>
              <li>
                <Link to="/search?type=Nicotine+Pouch" className="text-gray-300 hover:text-white transition-colors">
                  Nicotine Pouches
                </Link>
              </li>
            </ul>
