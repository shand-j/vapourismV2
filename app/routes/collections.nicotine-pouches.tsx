...
export async function loader({request, context}: LoaderFunctionArgs) {
  ...
  // Search for nicotine pouch products using productType filtering
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Link 
            to="/search?vendor=Nordic+Spirit&type=Nicotine+Pouch"
            className="group border-2 border-gray-200 rounded-xl p-6 hover:border-blue-500 hover:shadow-xl transition-all"
          >
      ...
      <div className="border-t-2 border-gray-200 pt-8">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          ...
          <Link to="/search?type=E-Liquid" className="px-6 py-3 bg-gray-100 hover:bg-blue-50 text-gray-800 rounded-lg hover:text-blue-700 transition font-medium">
            E-Liquids
          </Link>
